export default function reducer(state = {}, action) {
  switch (action.type) {
    ...
    case "ONLOAD_PAGE_USER_DETAILS": {
      const passInfo = localStorage.getItem("informations")
    ...
    case "TODO_DELETE": {
      ...
      return {
        ...state,
        userDetails: [
          ...state.userDetails.slice(0, index),
          ...state.userDetails.slice(index + 1)
        ]
      };
    }
    case "DONE_LOGOUT": {
    ...
    case "EDIT_VALUE": {
      ...
      return {
        ...state,
        userDetails: [
          ...state.userDetails.slice(0, ind),
          obj,
          ...state.userDetails.slice(ind + 1)
        ]
      };
    }
    ...
    case "CHECK_BOX": {
      ...
      return {
        ...state,
        userDetails: [
          ...state.userDetails.slice(0, inda),
          { ...state.userDetails[inda], ...obj },
          ...state.userDetails.slice(inda + 1)
        ]
      };
    }
